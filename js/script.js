...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 50.974486, lng: 4.250540, zoom: 13, zoomControl : true,
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 50.974486, lng: 4.250540, title: 'Celeg',
      infoWindow: { content: '<p>Terlinden 167, 1785 Merchtem</p>' } });
